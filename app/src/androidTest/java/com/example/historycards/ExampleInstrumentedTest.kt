...
class ExampleInstrumentedTest {
    ...
    fun welcomeTitle_isDisplayed() {
        ...
        onView(withId(R.id.welcome_message))
            .check(matches(withText("Welcome to History Flashcards!\n\nTest your knowledge of historical facts with this simple true/false quiz.\n\nThere are 5 questions waiting for you!")))
    }
